      ...
      <div className="mx-auto max-w-2xl text-center">
        {view === "loading" && (
          <section className="py-16">
            ...
            <p className="font-serif-display mt-7 text-3xl font-normal italic text-parchment">Opening your gift…</p>
          </section>
        )}
        ...
        {view === "gift" && gift && (
          <section>
            ...
            <h1 className="font-serif-display mt-4 text-5xl font-normal leading-[1.06] text-parchment">
              {gift.giver_name ? `${gift.giver_name} sent you a conversation.` : "You have been given a conversation."}
            </h1>

            {gift.message && (
              <blockquote className="font-serif-display mx-auto mt-7 max-w-xl border-l border-gold-soft pl-5 text-left text-xl font-normal italic leading-[1.65] text-parchment/90">
                “{gift.message}”
              </blockquote>
            )}

            <p className="mx-auto mt-7 max-w-xl text-sm font-normal leading-[1.85] text-parchment-dim">
            ...
            <div className="mt-8 border border-slate-200 bg-white p-5 text-left">
              <div className="flex gap-3">
                <ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-gold" />
                <div>
                  <p className="text-sm font-medium text-gold">Before you claim it</p>
            ...
            <label htmlFor="gift-phone" className="mt-7 block text-left text-sm font-medium text-gold">
            ...
            <input
              ...
              className="mt-3 w-full border border-slate-200 bg-white px-5 py-4 text-center text-base text-parchment outline-none placeholder:text-parchment-dim/45 focus:border-gold-soft"
            />
            ...
            <p className="mt-5 text-sm font-normal leading-relaxed text-parchment-dim">
        ...
        {view === "ready" && (
          <section className="py-8">
            ...
            <h1 className="font-serif-display mt-4 text-5xl font-normal text-parchment">Call whenever you want the conversation.</h1>
            <p className="mx-auto mt-5 max-w-lg text-sm font-normal leading-[1.8] text-parchment-dim">
            ...
            <a
              href={PHONE_TEL}
              className="font-serif-display mt-8 block text-3xl font-normal tracking-[0.08em] text-gold-bright hover:text-parchment"
            >
              {PHONE_DISPLAY}
            </a>
          </section>
        ...
        {view === "bad" && (
          <section className="py-10">
            ...
            <h1 className="font-serif-display mt-5 text-5xl font-normal text-parchment">{badMessage}</h1>
            <p className="mx-auto mt-5 max-w-lg text-sm font-normal leading-[1.8] text-parchment-dim">
            ...
            <a
              href="/begin/"
              className="mt-7 inline-block bg-[hsl(var(--gold))] px-7 py-4 text-sm font-semibold text-white"
            >
