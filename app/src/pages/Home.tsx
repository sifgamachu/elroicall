...
export default function Home() {
  return <div className="elroi-site"><Nav /><main id="main-content"><WellEntry /><DailyMoment /><DescentExperience /><StoryShelf /><ReturnRoomPreview /><Gift /><Faq /></main><Footer /></div>;
}
