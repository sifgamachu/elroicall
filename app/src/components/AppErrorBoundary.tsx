...
export default class AppErrorBoundary extends Component<{ children: ReactNode }, { failed: boolean }> {
  ...
  render() {
    ...
    return (
      <main className="grid min-h-screen place-items-center bg-[#0b0a08] px-6 text-parchment">
        <section role="alert" className="max-w-lg py-12 text-center">
          ...
          <a href={PHONE_TEL} className="mt-7 inline-flex bg-[hsl(var(--gold))] px-6 py-4 font-semibold text-[#17120a]">Call {PHONE_DISPLAY}</a>
